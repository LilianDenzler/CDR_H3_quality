...
ax1.text(5,6.5, "Pearson correlation coefficient:{}".format(round(r1[0],2)), fontsize=10, fontweight='bold')
...
ax2.text(5,20, "Pearson correlation coefficient:{}".format(round(r2[0],2)), fontsize=10, fontweight='bold')
