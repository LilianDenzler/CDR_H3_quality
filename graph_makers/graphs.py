...
ax1.set_xlabel('local_AA RMSD (Å)')
ax1.set_ylabel('global_AA RMSD (Å)')
...
ax2.set_xlabel('local_CA RMSD (Å)')
ax2.set_ylabel('global_CA RMSD (Å)')
...
ax3.set_xlabel('local_AA RMSD (Å)')
ax3.set_ylabel('local_CA RMSD (Å)')
...
ax4.set_xlabel('global_AA RMSD (Å)')
ax4.set_ylabel('global_CA RMSD (Å)')
